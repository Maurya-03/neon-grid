...
const WireframeRoom = () => {
  ...
  // Prevent body scroll on wireframe room pages
  useEffect(() => {
      ...
      case "image":
        return (
          <div className="border border-neon-cyan/30 rounded p-4 bg-bg-800/20">
            ...
            <div className="text-center text-xs text-neon-cyan/60">
              IMAGE PREVIEW
            </div>
            <div className="text-center text-xs mt-1 text-text-tertiary">
              {msg.content}
            </div>
          </div>
        );
      case "video":
        return (
          <div className="border border-neon-magenta/30 rounded p-4 bg-bg-800/20">
            ...
            <div className="text-center text-xs text-neon-magenta/60">
              VIDEO PREVIEW
            </div>
            <div className="text-center text-xs mt-1 text-text-tertiary">
              {msg.content}
      ...
      case "file":
        return (
          <div className="border border-neon-blue/30 rounded p-4 bg-bg-800/20">
            ...
            <div className="text-center text-xs text-neon-blue/60">
              FILE ATTACHMENT
            </div>
            <div className="text-center text-xs mt-1 text-text-tertiary">
              {msg.content}
      ...
      default:
        return (
          <div className="border border-text-secondary/30 rounded p-3 bg-bg-800/10">
            <div className="text-xs text-text-secondary/60 mb-1">
              TEXT MESSAGE
            </div>
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#050407] text-text-primary font-mono flex flex-col">
      {/* Wireframe Labels */}
      ...
      <div className="border-b border-text-secondary/20 bg-bg-900/50 relative flex-shrink-0">
        <div className="absolute -top-4 left-4 text-xs text-neon-cyan/60">
          HEADER BAR
        </div>
              ...
              <div className="border border-text-secondary/30 rounded p-2 relative">
                ...
                <div className="flex items-center space-x-2">
                  <div className="h-3 w-3 rounded-full border border-neon-green/50 relative">
                    <div className="absolute -top-4 left-0 text-xs text-neon-green/60">
                      STATUS
                    </div>
                  </div>
      ...
      <div className="flex">
        ...
        <div className="w-64 border-r border-text-secondary/20 bg-bg-900/30 relative">
          ...
          <div className="p-4 space-y-2">
            {[1, 2, 3, 4, 5].map((room) => (
              ...
              >
                {room === 2 && (
                  <div className="absolute -left-6 top-0 text-xs text-neon-cyan/60">
                    ACTIVE
                  </div>
                )}
                <div className="flex items-center space-x-2">
        ...
        <div className="flex-1 flex flex-col relative">
          ...
          <div className="flex-1 p-4 space-y-4 min-h-[calc(100vh-200px)] overflow-y-auto relative border border-text-secondary/10">
            <div className="absolute top-2 right-2 text-xs text-neon-cyan/60">
              SCROLL CONTAINER
            </div>
            ...
            {wireframeMessages.map((msg) => (
              ...
              >
                ...
                <div
                  className={`max-w-md border rounded-lg p-3 relative ${
                    msg.isOwn
                ...
                >
                  ...
                  {!msg.isOwn && (
                    <div className="border-b border-text-secondary/20 pb-1 mb-2 relative">
                      ...
                      <div className="text-sm font-medium text-neon-cyan/80">
                        {msg.username}
                      </div>
                    </div>
                  )}
                  ...
                  <div className="border-t border-text-secondary/20 pt-1 relative">
                    <div className="absolute -bottom-4 right-0 text-xs text-neon-cyan/60">
                      TIMESTAMP
                    </div>
          ...
          <div className="p-4 border-t border-text-secondary/20 relative">
            ...
            <div className="border border-text-secondary/30 rounded-lg p-4 bg-bg-800/20">
              ...
              <div className="mt-3 border-t border-text-secondary/20 pt-3 relative">
                <div className="absolute -top-6 left-0 text-xs text-neon-cyan/60">
                  ATTACHED MEDIA PREVIEW
                </div>
        ...
        {showUsers && (
          <div className="w-80 border-l border-text-secondary/20 bg-bg-900/30 relative">
            <div className="absolute -top-4 right-4 text-xs text-neon-cyan/60">
              USERS SIDEBAR
            </div>
            <div className="p-4">
              ...
              <div className="space-y-2 relative">
                ...
                {[1, 2, 3, 4].map((user) => (
                  <div
                    key={user}
                    className="border border-text-secondary/30 rounded p-3 flex items-center space-x-3"
                  >
                    <div className="relative">
                    ...
                    <div className="flex-1">
                      <div className="text-sm border-b border-text-secondary/20 pb-1">
                        User{user}
                      </div>
          ...
          <div className="w-80 border-l border-text-secondary/20 bg-bg-900/30 relative">
            ...
            <div className="p-4">
              ...
              <div className="flex space-x-2 mb-4 relative">
                ...
                <button className="border border-neon-cyan/50 rounded px-3 py-1 text-xs bg-neon-cyan/10">
                  ALL
                </button>
                <button className="border border-text-secondary/30 rounded px-3 py-1 text-xs">
                  IMAGES
                </button>
                <button className="border border-text-secondary/30 rounded px-3 py-1 text-xs">
                  VIDEOS
